...
Item.create!(name: "12-Piece Porcelain Dinnerware Set",         description: "Service for four; dishwasher + microwave safe.",         price: 59.99,  user: seller_b, category: "Home & Kitchen")
