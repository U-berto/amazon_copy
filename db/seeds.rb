...
item_1 = Item.create!(name: "12-Piece Porcelain Dinnerware Set",         description: "Service for four; dishwasher + microwave safe.",         price: 59.99,  user: seller_b, category: "Home & Kitchen")
Item.create!(name: "Non-Stick Frying Pan (10\")",               description: "PFOA-free skillet with stay-cool handle.",               price: 24.95,  user: seller_b, category: "Home & Kitchen")
Item.create!(name: "Memory Foam Contour Pillow",                description: "Ergonomic neck & shoulder support.",                      price: 29.99,  user: seller_b, category: "Home & Kitchen")
Item.create!(name: "8-Piece Stainless Steel Knife Set",         description: "Block + chef’s, paring, bread & steak knives.",          price: 79.99,  user: seller_b, category: "Home & Kitchen")
Item.create!(name: "Bamboo Cutting Board",                      description: "Reversible with juice groove.",                           price: 19.99,  user: seller_b, category: "Home & Kitchen")

Item.create!(name: "Eco-Friendly Yoga Mat",                     description: "6 mm thick, non-slip surface, strap included.",           price: 27.50,  user: seller_b, category: "Sports & Outdoors")
Item.create!(name: "Insulated Stainless Steel Water Bottle",    description: "32 oz; cold for 24 h or hot for 12 h.",                   price: 22.99,  user: seller_b, category: "Sports & Outdoors")
Item.create!(name: "Mountain Bike Helmet",                      description: "Lightweight, adjustable fit with vents.",                 price: 49.99,  user: seller_b, category: "Sports & Outdoors")
Item.create!(name: "Set of 3 Resistance Bands",                 description: "Light, medium, heavy tension workout bands.",             price: 15.99,  user: seller_b, category: "Sports & Outdoors")
Item.create!(name: "2-Person Camping Tent",                     description: "Water-resistant, easy setup, carry bag included.",       price: 69.99,  user: seller_b, category: "Sports & Outdoors")

Item.create!(name: "Rechargeable Electric Toothbrush",          description: "2-min timer, 3 modes, travel case.",                       price: 39.95,  user: seller_b, category: "Beauty & Personal Care")
Item.create!(name: "Facial Cleansing Brush",                    description: "Silicone bristles, waterproof, USB-C rechargeable.",      price: 24.99,  user: seller_b, category: "Beauty & Personal Care")
